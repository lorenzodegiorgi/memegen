    ...
    return (
        <div>
            ...
            <ul className="list-group">
                {props.memes
                    .slice() // crea una copia per non mutare l'array originale
                    .sort((a, b) => new Date(b.date) - new Date(a.date)) // ordina dal più recente al meno recente
                    .map(m => (
                        <MemeRow key={m.id} meme={m} deleteMeme={props.deleteMeme} />
                    ))
                }
